...
const Page = () => (
  <div style={{ backgroundImage: "url('bg.jpg')", opacity: 0.90 }} className="bg-cover bg-center ">
    ...
    <div className="main flex justify-center items-center h-[80vh]">
      <div className='flex flex-col justify-center items-center gap-8'>
        ...
        <button className='text-2xl w-36 h-36 rounded-full border-2 border-sky-800 shadow-lg shadow-sky-700/50'>
          Start
        </button>
      </div>
    </div>
